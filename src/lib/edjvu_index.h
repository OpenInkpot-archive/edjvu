...
Ecore_List *edjvu_index_item_children_get(const Edjvu_Index_Item * item);
int edjvu_index_item_page_get(const Edjvu_Document * document,
                              const Edjvu_Index_Item * item);
Ecore_List *edjvu_index_new(const Edjvu_Document * document);
void edjvu_index_delete(Ecore_List * index);
